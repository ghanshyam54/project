...
class LudoBoard:
    ...
    def __init__(self, master):
        self.canvas = tk.Canvas(master, width=Board.BOARD_WIDTH, height=Board.BOARD_HEIGHT, bg = 'black')
        ...
        self.title_bar = tk.Label(master, text="LudoKing", fg=Color.DEFAULT, bg=Color.CYAN, font=(None, 40), relief=tk.RAISED)
